 ...
 **********************************************************************************************/
	...
	this.renderBasketTable = function()
		...
		if ($('#bcontainer').length == 0)
			...
			$("body").append(" \
				...
				<div id='bfooter'> <button class='bbutton' onclick=\"cart.showWindow('order', 1)\">" + local.order + "</button><span id='bsum'>...</span></div> \
				</div> \
			");	
	...
	this.getForm = function (formId)
		...
		var INPUTS=[].slice.call( copyForm.querySelectorAll("input,textarea") );
